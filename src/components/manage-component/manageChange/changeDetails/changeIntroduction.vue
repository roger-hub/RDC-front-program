...
<el-form :model="ruleForm" :rules="rules" ref="ruleForm" :label-position="labelPosition" label-width="150px" class="demo-ruleForm">
    <el-form-item label="需要修改的介绍" prop="introduction">
        <el-input type="textarea" v-model="ruleForm.introduction" placeholder="请输入你的介绍" :autosize="{ minRows: 4, maxRows: 8}" class="text-introduction" maxlength="100" show-word-limit></el-input>
    </el-form-item>
    ...
    methods: {
        submitForm(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    this.handleInfo(this.ruleForm.introduction);
                } else {
