...
<div class="box clearfix">
    ...
    <ul class="messageList">
        <UnMessage v-for="(item, index) in list" :key="index" :id="ids[index]" @pushMsg="pushMsg">
...
<script>
import UnMessage from "@/components/manage-component/UnMessage";
...
export default {
    ...
    mounted() {
        this.$axios
            .post("/first/message/getAdminAllMessage", {})
            .then((res) => {
                console.log(res);
